...
> **Дыра, о которой надо знать.** В список файлов политики не входят
> `rustfmt.toml` и `flake.nix`. Расширять список без решения владельца
> не следует, но помните: их правка заслоном политики не ловится.
