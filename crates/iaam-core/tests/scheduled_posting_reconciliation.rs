...
//!
//! Пока графики здешних сценариев `initial_principal` не несут, и семь
//! тестов файла падают с `PrincipalUnknown`. Чинит это T13, задавая
//! номинал в графике — обычным путём, а не подменой состояния.
