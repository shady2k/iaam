...
| код категории торговой точки | merchant category code | the code a payment network assigns to a business, printed on a card export. Not one institution's vocabulary, so a rule written on it holds across institutions. Named as evidence and not yet a field (decision 0028 §4) |
