...
`python3 tools/actual-budget-migrate/migrate_categories.py --help` is the whole
interface.
...
```bash
python3 tools/actual-budget-migrate/migrate_categories.py \
...
```bash
IAAM_TOKEN=... python3 tools/actual-budget-migrate/migrate_categories.py \
